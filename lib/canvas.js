...
var Bitmap = function() 
{
	...
	this.create = function(rot, asCanvas) {
		...
		if ( asCanvas ) {
            console.log('rescode: barcode image created on canvas, returning as node canvas');
            return cvs;
		}

	  console.log('rescode: barcode image created on canvas, returning as DataURL');
